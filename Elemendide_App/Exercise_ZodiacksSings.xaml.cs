...
namespace Elemendide_App
{
    ...
    public partial class Exercise_ZodiacksSings : ContentPage
    {
        Label lbl;
        ...
        public Exercise_ZodiacksSings()
        {
            ...
            dataPicker.DateSelected += Dp_DateSelected;
            st = new StackLayout { Children = { dataPicker, img, lbl, linkButton } };
            Content = st;
        }

        private async void LinkButton_Clicked(object sender, EventArgs e)
        {
            await Browser.OpenAsync(lehed[index: linkNumber]);
        }
        ...
        private void Dp_DateSelected(object sender, DateChangedEventArgs e)
        {
            ...
            if (m == 1 && d >= 1 && d <= 20 || m == 12 && d <= 22)
            {
                img.Source = new UriImageSource
                {
                    ...
                    Uri = new Uri("https://www.mordovmedia.ru/media/articles/4174/0bea30ee3fff67b05b25a1dd61e49a91.jpg"),
                };
                ...
                linkButton.Text = "Find out information about sign: Козеро́г";
            }
            if (m == 3 && d >= 21 && d <= 31 || m == 4 && d <= 19)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://mixnews.lv/wp-content/uploads/2020/12/10/2020-12-10-mixnews-sunmag-1-oven-pervyy-v-zodiakakh.-pervyy-v-zhizni.jpg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: О́вен";
            }
            if (m == 4 && d >= 21 && d <= 30 || m == 5 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://uznayvse.ru/images/content/2020/3/uzn_15834823537.jpg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Теле́ц";
            }
            if (m == 5 && d >= 21 && d <= 31 || m == 6 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://cdn.nur.kz/images/1120x630/359378f6417b8477.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Близнецы";
            }
            if (m == 6 && d >= 21 && d <= 30 || m == 7 && d <= 22)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://uznayvse.ru/images/content/2020/5/uzn_15892692493.jpg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Рак";
            }
            if (m == 7 && d >= 23 && d <= 31 || m == 8 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://sunlight.net/wiki/wp-content/uploads/2020/12/talisman_lev_1.jpg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Лев";
            }
            if (m == 8 && d >= 23 && d <= 31 || m == 9 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://globalmsk.ru/usr/upload/upload-16208387720.jpg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Дева";
            }
            if (m == 9 && d >= 22 && d <= 31 || m == 10 && d <= 21)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://cdn.nur.kz/images/1120x630/418bef7dc4d1f568.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Весы";
            }
            if (m == 10 && d >= 22 && d <= 30 || m == 11 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://miro.medium.com/max/1400/1*iR48TxJPG_0aotZdSLA1xg.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Скорпион";
            }
            if (m == 11 && d >= 21 && d <= 31 || m == 12 && d <= 21)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://cdn.nur.kz/images/1120x630/d535a8566a427d33.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Стреле́ц";
            }
            if (m == 1 && d >= 20 && d <= 30 || m == 2 && d <= 18)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://cdn.nur.kz/images/1120x630/4bd1a07f1458c034.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Водолей";
            }
            if (m == 2 && d >= 19 && d <= 30 || m == 3 && d <= 20)
            {
                ...
                {
                    CachingEnabled = false,
                    Uri = new Uri("https://cdn.nur.kz/images/1120x630/cd6e23b3ae914d73.jpeg")
                };
                ...
                linkButton.IsVisible = true;
                linkButton.Text = "Find out information about sign: Рыбы";
            }
        }
    }
}